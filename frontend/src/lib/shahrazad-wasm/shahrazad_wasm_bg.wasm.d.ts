...
export const gamestate_new_local: (a: any, b: any, c: any) => [number, number, number];
export const gamestate_get_hash: (a: number) => [number, number, number];
export const gamestate_get_bytes_str: (a: number) => [number, number, number];
...
export const decode_server_update: (a: any) => [number, number, number];
